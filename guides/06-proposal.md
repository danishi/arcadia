...
|-------------|----------|-------------|
| 提案書ボリューム (PPTX) | `RFP_answer/Vol{N}-{topic}.pptx` | PPTX method: PowerPointファイル |
| 提案書ボリューム (画像) | `RFP_answer/Vol{N}-{topic}/slide-{NN}.png` | NanoBanana method: スライド画像 |
...
出力先: RFP_answer/Vol1-overview/slide-01.png 〜 slide-XX.png
アスペクト比: 16:9
```
