...
6. リスクと対策
7. 体制・パートナー方針
出力先: source/rfp_answer_output/proposal-strategy.md
```
...
出力先: source/rfp_answer_output/proposal-items-checklist.md
```
...
出力先: source/rfp_answer_output/as-is-to-be-comparison.md
```
