...
| `rfp-analysis.md` | `source/rfp_answer_output/` | RFP解析サマリー（要旨、主要要件、リスク） |
...
5. スケジュール要件
6. ドメイン用語表
出力先: source/rfp_answer_output/rfp-analysis.md
```
...
各要件に対する適合度を ○/△/× で評価して。
出力先: source/rfp_answer_output/competitive-analysis.md
```
