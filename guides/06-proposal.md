...
- 使用する図面（あれば）
- スピーカーノート
出力先: source/rfp_answer_output/vol1-overview-slides.md
```
...
出力先: output/Vol1-overview.pptx
```

#### NanoBanana method（`SLIDE_METHOD=nanobanana` の場合）

```
vol1-overview-slides.md を元に、NanoBananaスキルでスライド画像を1枚ずつ生成して。
出力先: output/Vol1-overview/slide-01.png 〜 slide-XX.png
アスペクト比: 16:9
```
