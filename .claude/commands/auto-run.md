...
| 判断項目 | AI仮決定の方針 |
|---------|--------------|
| 人月単価 | `org-data/rate-card.md` が存在すればその値を使用。なければ一般的な IT コンサル単価（PjM: 200万/月、アーキテクト: 180万/月、SE: 150万/月、テスター: 120万/月）を仮設定し `[AUTO][要確認]` を付与 |
...
| 2 | 4 | 人月単価 | PjM: 200万/月 | org-data 未設定のためデフォルト値 |
| ... | | | | |
```
